...
#import "MLGMAccountManager.h"
#import "MLGMWebService.h"

@interface MLGMAccountManager()
...
@implementation MLGMAccountManager
...
- (void)updateAccountProfileToDBCompletion:(void(^)(MLGMAccount *account, NSError *error))completion {
    NSURLRequest *urlRequest = [[MLGMWebService sharedInstance] getRequestWithEndPoint:@"/user" parameters:nil];
    [[MLGMWebService sharedInstance] startRequest:urlRequest patternFile:@"userPattern.json" completion:^(NSDictionary *responHeaderFields, NSInteger statusCode, id responseObject, NSError *error) {
        if (error) {
...
- (void)fetchUserProfileForUserName:(NSString *)userName completion:(void(^)(MLGMActorProfile *userProfile, NSError *error))completion {
    ...
    NSURLRequest *urlRequest = [[MLGMWebService sharedInstance] getRequestWithEndPoint:endPoint parameters:nil];
    [[MLGMWebService sharedInstance] startRequest:urlRequest patternFile:@"userPattern.json" completion:^(NSDictionary *responHeaderFields, NSInteger statusCode, id responseObject, NSError *error) {
        if (error) {
...
- (void)fetchOrganizationInfoForUserName:(NSString *)userName fromPage:(NSUInteger)page completion:(void(^)(NSArray *orgMOs, BOOL isReachEnd, NSError *error))completion {
    ...
    NSURLRequest *urlRequest = [[MLGMWebService sharedInstance] getRequestWithEndPoint:endPoint parameters:parameters];
    [[MLGMWebService sharedInstance] startRequest:urlRequest patternFile:@"organizationPattern.json" completion:^(NSDictionary *responHeaderFields, NSInteger statusCode, NSArray *responseObject, NSError *error) {
        if (error) {
...
- (void)fetchOrganizationUpdateDateForOrgName:(NSString *)orgName completion:(void(^)(NSDate *updatedAt, NSString *orgName, NSError *error))completion {
    ...
    NSURLRequest *request = [[MLGMWebService sharedInstance] getRequestWithEndPoint:endPoint parameters:nil];
    [[MLGMWebService sharedInstance] startRequest:request patternFile:@"userPattern.json" completion:^(NSDictionary *responHeaderFields, NSInteger statusCode, NSDictionary *responseObject, NSError *error) {
        if (error) {
...
- (void)fetchStarCountForUserName:(NSString *)userName completion:(void(^)(NSUInteger starCount, NSString *userName, NSError *error))completion {
    ...
    NSDictionary *parameters = @{@"page" : @(1), @"per_page" : @(1)};
    NSURLRequest *urlRequest = [[MLGMWebService sharedInstance] getRequestWithEndPoint:endPoint parameters:parameters];
    [[MLGMWebService sharedInstance] startRequest:urlRequest patternFile:@"reposPattern.json" completion:^(NSDictionary *responHeaderFields, NSInteger statusCode, NSArray *responseObject, NSError *error) {
        if (error) {
...
- (void)checkFollowStatusForUserName:(NSString *)sourceUserName followTargetUserName:(NSString *)targetUserName completion:(void(^)(BOOL isFollow, NSString *targetUserName, NSError *error))completion {
    ...
    NSURLRequest *urlRequest = [[MLGMWebService sharedInstance] getRequestWithEndPoint:endPoint parameters:nil];
    [[MLGMWebService sharedInstance] startRequest:urlRequest patternFile:nil completion:^(NSDictionary *responHeaderFields, NSInteger statusCode, id responseData, NSError *error) {
...
- (void)followTargetUserName:(NSString *)targetUserName completion:(void(^)(BOOL isFollow, NSString *targetUserName, NSError *error))completion {
    ...
    NSURLRequest *urlRequest = [[MLGMWebService sharedInstance] putRequestWithEndPoint:endPoint parameters:nil];
    [[MLGMWebService sharedInstance] startRequest:urlRequest patternFile:nil completion:^(NSDictionary *responHeaderFields, NSInteger statusCode, id responseData, NSError *error) {
...
- (void)unfollowTargetUserName:(NSString *)targetUserName completion:(void(^)(BOOL isUnFollow, NSString *targetUserName, NSError *error))completion {
    NSString *endPoint = [NSString stringWithFormat:@"/user/following/%@", targetUserName];
    NSURLRequest *urlRequest = [[MLGMWebService sharedInstance] deleteRequestWithEndPoint:endPoint parameters:nil];
    [[MLGMWebService sharedInstance] startRequest:urlRequest patternFile:nil completion:^(NSDictionary *responHeaderFields, NSInteger statusCode, id responseData, NSError *error) {
        NSPredicate *p = [NSPredicate predicateWithFormat:@"sourceLoginName = %@ and targetLoginName = %@", kOnlineUserName, targetUserName];
...
- (void)fetchFollowerListForUserName:(NSString *)userName fromPage:(NSUInteger)page completion:(void(^)(NSArray *userProfiles, BOOL isReachEnd, NSError *error))completion {
    ...
    NSDictionary *parameters = @{@"page" : @(page), @"per_page" : @(kPerPage)};
    NSURLRequest *urlRequest = [[MLGMWebService sharedInstance] getRequestWithEndPoint:endPoint parameters:parameters];
    [[MLGMWebService sharedInstance] startRequest:urlRequest patternFile:@"followerPattern.json" completion:^(NSDictionary *responHeaderFields, NSInteger statusCode, NSArray *responseObject, NSError *error) {
        if (error) {
            DDLogError(@"access /user/%@/orgs api error:%@", userName, error.localizedDescription);
...
- (void)forkRepo:(NSString *)repoName completion:(void(^)(BOOL succeeded, NSString *repoName, NSError *error))completion {
    ...
    NSURLRequest *urlRequest = [[MLGMWebService sharedInstance] postRequestWithEndPoint:endPoint parameters:nil];
    [[MLGMWebService sharedInstance] startRequest:urlRequest patternFile:nil completion:^(NSDictionary *responHeaderFields, NSInteger statusCode, id responseData, NSError *error) {
        if (statusCode == 202) {
            NSPredicate *p = [NSPredicate predicateWithFormat:@"loginName = %@ and repoName = %@", kOnlineUserName, repoName];
            MLGMTagRelation *tagRelation = [MLGMTagRelation MR_findFirstWithPredicate:p inContext:self.defaultContext];
...
- (void)searchByRepoName:(NSString *)repoName sortType:(MLGMSearchRepoSortType)sortType fromPage:(NSUInteger)page completion:(void(^)(NSArray *repos, BOOL isReachEnd, NSError *error))completion {
    ...
    NSURLRequest *urlRequest = [[MLGMWebService sharedInstance] getRequestWithEndPoint:endPoint parameters:parameters];
    [[MLGMWebService sharedInstance] startRequest:urlRequest patternFile:@"searchReposPattern.json" completion:^(NSDictionary *responHeaderFields, NSInteger statusCode, id responseData, NSError *error) {
        if (error) {
...
- (void)searchByUserName:(NSString *)userName sortType:(MLGMSearchUserSortType)sortType fromPage:(NSUInteger)page completion:(void(^)(NSArray *users, BOOL isReachEnd, NSError *error))completion {
    ...
    NSURLRequest *urlRequest = [[MLGMWebService sharedInstance] getRequestWithEndPoint:endPoint parameters:parameters];
    [[MLGMWebService sharedInstance] startRequest:urlRequest patternFile:@"searchUsersPattern.json" completion:^(NSDictionary *responHeaderFields, NSInteger statusCode, id responseData, NSError *error) {
        if (error) {
...
- (void)fetchRecommendationReposFromPage:(NSUInteger)page completion:(void(^)(NSArray *repos, BOOL isReachEnd, NSError *error))completion {
    ...
    [MLCloudCode callFunctionInBackground:@"repositories" withParameters:parameters block:^(NSArray *cloudObjects, NSError *error) {
        ...
        BOOL valid = [[MLGMWebService sharedInstance].jsonValidation verifyJSON:cloudObjects pattern:pattern];
        if (!valid) {
...
- (void)genesFromGitHubCompletion:(void(^)(NSArray *allGeneMOs, NSError *error))completion {
    ...
    NSURLRequest *urlRequest = [[MLGMWebService sharedInstance] getRequestWithEndPoint:endPoint parameters:parameters];
    [[MLGMWebService sharedInstance] startRequest:urlRequest patternFile:@"reposPattern.json" completion:^(NSDictionary *responHeaderFields, NSInteger statusCode, NSArray *responseObjects, NSError *error) {
        if (error) {
            BLOCK_SAFE_ASY_RUN_MainQueue(completion, nil, error);
