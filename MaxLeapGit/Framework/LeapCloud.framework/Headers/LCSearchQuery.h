 ...
 *
 *  @note: The from and size properties will not work for `LCSearchQuery`s created by this method.
 *
 *  @param dictionary The entire search query element. You should construct the whole search query in your app.
 *
 *  @return A LCSearchQuery instance.
 */
...
- (void)findObjectsInBackgroundWithBlock:(LCDictionaryResultBlock)block;
