 ...
 */
typedef NS_ENUM(NSUInteger, LCInAppMessageDismissButtonLocation){
    
    /** top left corner */
    LCInAppMessageDismissButtonLocationLeft,
    
    /** top right corner */
    LCInAppMessageDismissButtonLocationRight
};

/**
 *  Enter point to enable marketing to recieve In-App messages and test In-App messages.
 */
@interface LCMarketingManager : NSObject
...
/** Enable LeapCloud SDK In-App message test mode. In test mode a small
 *  LeapCloud tab will appear on the left side of the screen, enabling a developer to see/test
 ...
 */
+ (void)setInAppMessageDismissButtonLocation:(LCInAppMessageDismissButtonLocation)location;

/** Returns the location of the dismiss button on an In-App msg
 @return InAppDismissButtonLocation
 @see inAppMessageDismissButtonLocation
 */
+ (LCInAppMessageDismissButtonLocation)inAppMessageDismissButtonLocation;
