...
typedef NS_ENUM(NSUInteger, LC_SSKeychainQuerySynchronizationMode) {
	LC_SSKeychainQuerySynchronizationModeAny,
	LC_SSKeychainQuerySynchronizationModeNo,
	LC_SSKeychainQuerySynchronizationModeYes
};
#endif
 ...
 */
@interface LC_SSKeychainQuery : NSObject
...
@property (nonatomic) LC_SSKeychainQuerySynchronizationMode synchronizationMode;
#endif
