...
/**
 ...
 platform.
 */
typedef NS_ENUM(OSStatus, LC_SSKeychainErrorCode) {
	/** Some of the arguments were invalid. */
	LC_SSKeychainErrorBadArguments = -1001,
};

/** SSKeychain error domain */
FOUNDATION_EXPORT NSString *const LC_kSSKeychainErrorDomain;

/** Account name. */
FOUNDATION_EXPORT NSString *const LC_kSSKeychainAccountKey;
 ...
 */
FOUNDATION_EXPORT NSString *const LC_kSSKeychainCreatedAtKey;

/** Item class. */
FOUNDATION_EXPORT NSString *const LC_kSSKeychainClassKey;

/** Item description. */
FOUNDATION_EXPORT NSString *const LC_kSSKeychainDescriptionKey;

/** Item label. */
FOUNDATION_EXPORT NSString *const LC_kSSKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
FOUNDATION_EXPORT NSString *const LC_kSSKeychainLastModifiedKey;

/** Where the item was created. */
FOUNDATION_EXPORT NSString *const LC_kSSKeychainWhereKey;
 ...
 */
@interface LC_SSKeychain : NSObject
