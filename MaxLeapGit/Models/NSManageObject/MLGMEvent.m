...
- (void)fillObject:(NSDictionary *)object {
    ...
    if ([type isEqualToString:@"WatchEvent"]) {
        ...
        self.createTime = [[object valueForKeyPath:@"created_at"] toDate];
...
- (NSString *)description {
    NSString *description = [NSString stringWithFormat:@"%@: \n type=%@\n actorName=%@\n avatarUlr=%@\n sourceRepoName=%@\n targetRepoName=%@\n createTime=%@\n", NSStringFromClass(self.class), self.type, self.actorName, self.avatarUrl, self.sourceRepoName, self.targetRepoName, self.createTime];
